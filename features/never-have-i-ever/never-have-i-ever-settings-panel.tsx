...
interface NeverHaveIEverSettingsPanelProps {
  isAdult: boolean;
  onChange: (settings: NeverHaveIEverSettings) => void;
  onOpenSettings: () => void;
...
export function NeverHaveIEverSettingsPanel({
  settings,
  isAdult,
  palette,
  t,
  onChange,
  onOpenSettings,
}: NeverHaveIEverSettingsPanelProps) {
  const selectedCount = settings.selectedCategoryIds.length;

  function updateSettings(nextSettings: NeverHaveIEverSettings) {
    onChange(clampNeverHaveIEverSettings(nextSettings, isAdult));
  }

  function toggleCategory(categoryId: NeverHaveIEverCategoryId) {
    ...
    <View style={styles.container}>
      <View style={styles.settingGroup}>
        <View style={styles.headerText}>
          <Text style={[styles.label, { color: palette.text }]}>
            {t("neverHaveIEver.settings.categories")}
          </Text>
          <Text style={[styles.metaText, { color: palette.mutedText }]}>
            {t("neverHaveIEver.settings.categorySummary").replace(
              "{count}",
        ...
        <View style={styles.categoryList}>
          {neverHaveIEverCategories.map((category) => {
                ...
                <View style={styles.categoryText}>
                  <View style={styles.categoryTitleRow}>
                    ...
                    {category.isAdultOnly ? (
                      ...
                      >
                        {t("neverHaveIEver.settings.adultBadge")}
                      </Text>
                    ) : null}
                  </View>
                  <Text
                  ...
                  >
                    {isLocked
                      ? t("neverHaveIEver.settings.lockedHint")
      ...
      >
        ...
        <View style={styles.switchText}>
          <Text style={[styles.label, { color: palette.text }]}>
            {t("neverHaveIEver.settings.adultUnlock")}
          </Text>
          <Text style={[styles.metaText, { color: palette.mutedText }]}>
            {isAdult
              ? t("neverHaveIEver.settings.adultUnlocked")
              : t("neverHaveIEver.settings.openSettingsHint")}
          </Text>
        </View>
      </Pressable>
      ...
      >
        <View style={styles.switchText}>
          <View style={styles.categoryTitleRow}>
            ...
            >
              {t("neverHaveIEver.settings.alcoholMode")}
            </Text>
          ...
          <Text style={[styles.metaText, { color: palette.mutedText }]}>
            {isAdult
              ? t("neverHaveIEver.settings.alcoholModeHelp")
              : t("neverHaveIEver.settings.lockedHint")}
          </Text>
        </View>
        <View
